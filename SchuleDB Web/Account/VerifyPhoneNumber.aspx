<%@ Page Title="Telefonnummer überprüfen" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="Groll.Schule.SchuleDBWeb.Account.VerifyPhoneNumber" %>
