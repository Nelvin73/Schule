...
namespace Groll.Schule.OutputTools
{
    public static class OutputTemplateManager
    {
        ...
        static OutputTemplateManager()
        {
            ...
            Register(new GrundrechnenÜbungOutput("Test2", "oijpoijopijoeqrwerqwerwerpij\noüijpoijopij", "Arbeitsblätter", "Englisch", false) );
            Register(new GrundrechnenÜbungOutput("Test3", "fasdfasdfasdfwedfewf\noüijpoijopij", "ddddddddd", ""));
            Register(new GrundrechnenÜbungOutput("TestX", "fasdfasdfasdfwedfewf\noüijpoijopij", "", ""));
            Register(new GrundrechnenÜbungOutput("Test4", "r34rt2t23t32r\noüijpoijopij", "ddddddddd", "ssss"));
            Register(new GrundrechnenÜbungOutput("Test4", "r34rt2t23t32r\noüijpoijopij", "d2222ddddd", "ssss"));
        }
